...
**Shared with the rest of the stack: see `docs/superpowers/plans/2026-09-09-webshop-v2-web-constraints.md`** — extracted after this PR merged, so PR 4 and PR 5 share one copy rather than three that drift. Everything that was in this section lives there, including the eleven amendments this branch made to it.
